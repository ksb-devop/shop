...
import S2slider from "../../../componenets/rex/productCarousel/S2slider.jsx";
...
const s2 = () => {
  ...
  return (
    <div>
      <Head>
        <title>Rex Royal S2 || Kaffee-Service Berlin Peter Ganss GmbH</title>
      ...
      >
        <Breadcrumb fontWeight="medium" fontSize="sm">
          ...
          <BreadcrumbItem isCurrentPage>
            <BreadcrumbLink href="#">Rex Royal S2 </BreadcrumbLink>
          </BreadcrumbItem>
        </Breadcrumb>
      </Box>
      <Container maxW={"7xl"}>
            ...
            <TabPanels>
              <TabPanel>
                ...
                >
                  ...
                  >
                    Echte Leidenschaﬅ und 100 % Swissness. Dies und mehr steckt
                    in der Rex-Royal S2, der Proﬁkaﬀeemaschine für den mittleren
                    Kapazitätsbedarf. Ein intuitiver, videofähiger 7-Zoll
                    TouchScreen bietet eine ganze Bandbreite individueller
                    Getränkekreationen an – vom Espresso, dem klassischen Kaﬀee,
                    bis zu zahlreichen Milch- und Mischgetränken wie Cappuccino,
                    Latte Macchiato oder heisse Schokolade. Mit dem opti-onalen
                    CompactFoam können Sie zusätzlich den perfekten, warmen oder
                    kalten Milchschaum auf Knopfdruck zubereiten und damit eine
                    noch grössere Getränkevielfalt anbieten. Diese Proﬁmaschine
                    macht es möglich, gleichzeitig einen oder zwei Kaﬀees,
                    Heisswasser und Dampf zu beziehen.
                  </Text>
                  ...
                  <Text
                    ...
                    mt={{ base: "10px", lg: "80px" }}
                  >
                    Die hochwertige und leistungsstarke Rex-Royal
                    Metall-Brühgruppe mit einem Fassungsvermögen von bis zu 16
                    Gramm Kaffeepulver sorgt für höchste Kaffeequalität und
                    garantiert sowohl für Einzel- als auch für Doppelprodukte
                    eine optimale Extraktion. Mit dem professionellen Rex-Royal
                    Tee-/Dampf Boiler-System mit einer
                    Heisswasserstundenleistung von bis zu 28 Litern, ist der
                    Tee-Bezug sogar gleichzeitig zur Kaffeeausgabe möglich.
                  </Text>
                  <Image
                    p={6}
                    w={"950px"}
