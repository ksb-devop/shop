...
import X8cslider from "../../../componenets/jura/productCarousel/X8cslider.jsx";
...
const x8c = () => {
  ...
  return (
    <div>
      <Head>
        <title>Giga X8c || Kaffee-Service Berlin Peter Ganss GmbH</title>
      ...
      >
        <Breadcrumb fontWeight="medium" fontSize="sm">
          ...
          <BreadcrumbItem isCurrentPage>
            <BreadcrumbLink href="#">Giga X8c </BreadcrumbLink>
          </BreadcrumbItem>
        </Breadcrumb>
      </Box>
      <Container maxW={"7xl"}>
            ...
            >
              <VStack spacing={{ base: 4, sm: 6 }}>
                <Text
                  ...
                  textAlign={{ base: "center", lg: "left" }}
                >
                  Die GIGA X8c ist eine Neuentwicklung auf Basis der langjährigen Erfahrung aus dem Hause Jura für die professionelle Kaffeeversorgung. Die einzigartiger Speed-Funktion bietet perfekten Kaffeegenuss in Rekordzeit - ideal bei maximaler Auslastung. Sehr belastbar für einen täglichen Bezug von täglich 200 Tassen höchsten Kaffeegenuss. Mit den 2 Farbvarianten Chrom und Schwarz passt sie sich perfekt in Ihre Küche ein.
                </Text>
              </VStack>
            </Stack>
          </Stack>
              ...
              <TabPanel>
                <Box py={12}>
                  <List fontSize={"lg"} spacing={4}>
                    ...
                    <ListItem>
                      <ListIcon as={StarIcon} color="green.500" />
                      320x565x497mm (BxHxT), 19kg, 220-240V, 2700W
                    </ListItem>
                  </List>
                </Box>
              </TabPanel>
